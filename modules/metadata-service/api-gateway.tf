    ...
    "Statement": [
        {
            ...
            "Resource": "arn:${var.iam_partition}:execute-api:${data.aws_region.current.region}:${data.aws_caller_identity.current.account_id}:${aws_api_gateway_rest_api.this.id}/*/*/*"
        },
        {
            "Effect": "Deny",
            "Principal": "*",
