...
| <a name="input_compute_environment_allocation_strategy"></a> [compute\_environment\_allocation\_strategy](#input\_compute\_environment\_allocation\_strategy) | The allocation strategy for the Batch Compute environment | `string` | `"BEST_FIT"` | no |
